...
export const holidaySubtitles = {
  ...
  "Remembering 9/11":
    "We will never forget the lives lost and the heroes who stood tall 🇺🇸",
  "St.Patricks Day": "May the luck of the Irish be with you! ☘️",
  "Cinco de Mayo": "Celebrating Mexican heritage and culture! 🇲🇽🎉",
  "Adult Holy Hour":
    "Take a moment to reflect, pray, and adore Christ in the Eucharist.",
  "Youth Holy Hour":
    "An evening of worship, praise, and connection with Christ for our youth.",
};
